...
get_pairs <- function(em, metric) {
  as.data.frame(emmeans::contrast(em, "pairwise", adjust = "tukey")) %>%
    mutate(metric = metric)
}

table_s2 <- bind_rows(
  get_pairs(q0_lm_means, "q0"),
  get_pairs(q1_lm_means, "q1"),
  get_pairs(q2_lm_means, "q2")
) %>%
