...
filtered_metadat <- metadat[metadat$Study_zone %in% c("Estero_pargo", "Rio San Pedro", "Laguna Cacahuate", "Celestún"), ]
...
saveRDS(filtered_physeq2, file = "rds/compare_mangroves/physeq_objeto_Estero.rds") 
```
...
samples_plot <- ggplot(metadata, aes(x = Mangrove.system, y = after_stat(count),
